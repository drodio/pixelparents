...
// signalQuality. An attendee earned 25 authoritative points (SEC Form D) yet was
// routed to /not-this-round because Claude rated their thin web footprint
...
describe("deriveEvalStatus", () => {
  it("shows the profile whenever a positive score was generated", () => {
    expect(deriveEvalStatus(25)).toBe("scored"); // the attendee — was hidden before
