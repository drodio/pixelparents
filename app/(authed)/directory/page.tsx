...
async function ThumbnailedShowcase({
  ...
  return <ShowcaseClient cards={await cards} viewerIsStudent={viewerIsStudent} />;
}
...
export default async function CommunityPage() {
  ...
  // Directory perspective default: a student viewer sees students first, a parent
  // (or non-family) viewer sees parents first. Either can flip it with the toggle.
  const viewerIsStudent = viewerSignup ? isStudentAccount(viewerSignup) : false;
        ...
        <section>
          {heroCards.length === 0 ? (
            ...
            <Suspense fallback={<ShowcaseSkeleton />}>
              <ShowcaseClient cards={heroCards} viewerIsStudent={viewerIsStudent} />
            </Suspense>
          ) : (
            ...
            <Suspense fallback={<ShowcaseClient cards={heroCards} viewerIsStudent={viewerIsStudent} />}>
              <ThumbnailedShowcase cards={thumbnailedCards} viewerIsStudent={viewerIsStudent} />
            </Suspense>
          )}
        </section>
      </div>
