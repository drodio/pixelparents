...
export const metadata = {
  title: "Terms of Service — Pixel Parents",
  description:
    "The friendly, plain-language terms for using Pixel Parents — a free, open-source community project for Stanford OHS families.",
};
      ...
      <div className="mx-auto flex w-full max-w-2xl flex-col gap-8">
        ...
        <section className="flex flex-col gap-3">
          ...
          <p className="text-white/70">
            Pixel Parents is a free, community-run tool that helps Stanford OHS
        ...
        <section className="flex flex-col gap-3">
          ...
          <p className="text-white/70">
            You can stop using Pixel Parents whenever you like and request that we
